...
export default {
  ...
  content: (
    <div>
      ...
      <p>
        Egenda has reached the Top 50 Education app on the US App Store and has
        been featured on KLIF News, Plano Star Courier, and the Texas Jewish
        Post.
      </p>
      <div className="scrolling-carousel">
        <img
          src="/img/egenda/egenda_ad_post.png"
          alt="Egenda introduction and explanation"
        />
        <img
          src="/img/egenda/classes_view.png"
          alt="screenshot of a student's classes in the app"
        />
        <img
          src="/img/egenda/schedule_view.png"
          alt="screenshot of a student's schedule in the app"
        />
        <img
          src="/img/egenda/assignment_view.png"
          alt="screenshot of a student's assignment in the app"
        />
      </div>
